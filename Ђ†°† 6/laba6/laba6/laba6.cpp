...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        pF[1] = new MyPolygon(150, 2, 5, 0, RGB(0, 255, 0), hWnd, 4);
        pF[2] = new MyPolygon(70, 3, 3, 1, RGB(0, 0, 255), hWnd, 4);
        ...
        pF[6] = new MyRomb(250, 1, 10, 0, RGB(255, 0, 0), hWnd, 4);
        pF[7] = new MyRomb(132, 2, 5, 0, RGB(0, 255, 0), hWnd, 4);
        pF[8] = new MyRomb(72, 1, 10, 0, RGB(0, 0, 255), hWnd, 4);
        break;
    case WM_TIMER:
        for (int i = 0; i < 9;i++) {
            pF[i]->draw(0);
